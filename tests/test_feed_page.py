...
class TestFeedPage:
    ...
    def test_changes_counter_for_quantity_of_orders_success(self, driver, set_user_tokens):
        ...
        feed_page = FeedPage(driver)
        main_page.click_header_feed_button()
        orders_count_1 = int(feed_page.get_quantity_of_orders())
        ...
        driver.refresh()
        main_page.click_header_feed_button()
        orders_count_2 = int(feed_page.get_quantity_of_orders())

        print(f"[DEBUG] Before: {orders_count_1} | After: {orders_count_2}")
    ...
    def test_changes_counter_for_daily_quantity_of_orders_success(self, driver, set_user_tokens):
        ...
        feed_page = FeedPage(driver)
        main_page.click_header_feed_button()
        orders_count_1 = int(feed_page.get_daily_quantity_of_orders())
        main_page.click_on_button_constructor()
        main_page.click_on_button_login_in_main()
        main_page.drag_and_drop_ingredient_to_order()
        main_page.click_on_button_make_order()
        ...
        driver.refresh()
        main_page.click_header_feed_button()
        orders_count_2 = int(feed_page.get_daily_quantity_of_orders())

        print(f"[DEBUG] Daily BEFORE: {orders_count_1} | AFTER: {orders_count_2}")
